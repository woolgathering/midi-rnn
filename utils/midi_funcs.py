...
def simple_parse_midi(midifile, trackNum = 0, tempo):
  ...
  for i, msg in enumerate(track):
      if msg.type=='note_on':
          this_rhythm = get_rhythm(msg.time, mid.ticks_per_beat) * -1 # negative since the last beat was a rest
      ...
      if msg.type=='note_off':
          this_rhythm = get_rhythm(msg.time, mid.ticks_per_beat) # negative since the last beat was a rest
